...
public class Messages {
    ...
    private static final String APPEAL_MESSAGE = CC.GRAY + "\nIf you believe this was a false ban, you can appeal it at "
            + CC.YELLOW + "http://appeal.prac.lol" + CC.GRAY + " or buy an unban at " + CC.YELLOW + "http://prac.lol.buycraft.net" + CC.GRAY + ".";
    ...
    public static final String DISCORD_LINK = "discord.me/" + LandCore.getInstance().getNetworkName();
