...
public class InventoryUI {
    ...
    public static class InventoryUIHolder implements InventoryHolder, me.devkevin.landcore.utils.inventory.InventoryUIHolder {
    ...
    public static void removeCrafting(Material material) {
        Iterator<Recipe> iterator = LandCore.getInstance().getServer().recipeIterator();
