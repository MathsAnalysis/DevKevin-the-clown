package me.devkevin.landcore.utils.location;
...
public class CustomLocation {
    ...
    public World toBukkitWorld() {
        if (this.world == null) {
            return LandCore.getInstance().getServer().getWorlds().get(0);
        } else {
            return LandCore.getInstance().getServer().getWorld(this.world);
        }
    }
